...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        planets = [
            ...
            (9,  'கே',   'கேது (கே)'),
            (10, 'லக்',  'லக்னம் (லக்)'),
            (11, 'சூரி,ச',   'சூரியன் + சந்திரன்'),
            (12, 'சூரி,செ',  'சூரியன் + செவ்வாய்'),
            (13, 'சூரி,பு',  'சூரியன் + புதன்'),
            (14, 'சூரி,கு',  'சூரியன் + குரு'),
            (15, 'சூ,சனி', 'சூரியன் + சனி'),
            (16, 'சந்,செ',   'சந்திரன் + செவ்வாய்'),
            (17, 'சந்,கு',   'சந்திரன் + குரு'),
            (18, 'ச,சனி',  'சந்திரன் + சனி'),
            (19, 'செவ்,கு',  'செவ்வாய் + குரு'),
