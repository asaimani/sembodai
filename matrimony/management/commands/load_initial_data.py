...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        rasis_data = [
            ...
            ('ரிஷபம்',     ['கார்த்திகை (2)', 'கார்த்திகை (3)', 'கார்த்திகை (4)', 'ரோகிணி', 'மிருகசீரிடம் (1)', 'மிருகசீரிடம் (2)']),
            ('மிதுனம்',    ['மிருகசீரிடம் (3)', 'மிருகசீரிடம் (4)', 'திருவாதிரை', 'புனர்பூசம் (1)', 'புனர்பூசம் (2)', 'புனர்பூசம் (3)']),
            ('கடகம்',      ['புனர்பூசம் (4)', 'பூசம்', 'ஆயில்யம்']),
            ('சிம்மம்',    ['மகம்', 'பூரம்', 'உத்திரம் (1)']),
            ('கன்னி',      ['உத்திரம் (2)', 'உத்திரம் (3)', 'உத்திரம் (4)', 'அஸ்தம்', 'சித்திரை (1)', 'சித்திரை (2)']),
            ('துலாம்',     ['சித்திரை (3)', 'சித்திரை (4)', 'சுவாதி', 'விசாகம் (1)', 'விசாகம் (2)', 'விசாகம் (3)']),
            ('விருச்சிகம்',['விசாகம் (4)', 'அனுஷம்', 'கேட்டை']),
            ('தனுசு',      ['மூலம்', 'பூராடம்', 'உத்திராடம் (1)']),
            ('மகரம்',      ['உத்திராடம் (2)', 'உத்திராடம் (3)', 'உத்திராடம் (4)', 'திருவோணம்', 'அவிட்டம் (1)', 'அவிட்டம் (2)']),
            ('கும்பம்',    ['அவிட்டம் (3)', 'அவிட்டம் (4)', 'சதயம்', 'பூரட்டாதி (1)', 'பூரட்டாதி (2)', 'பூரட்டாதி (3)']),
